...
const SideNav=()=>{
    ...
    let [showSidebnav,setShowSideNav]=useState(false);
        ...
        <>
            <section className=" relative flex gap-10 py-0 max-md:flex-col">
                 ...
                 <div className="sticky top-[80px] z-30">
                    ...
                    <div className={"min-w-[200px] h-[calc(100vh-80px-60px)]md:h-cover md:sticky top-24 overflow-y-auto p-6 md:pr-0 md:border-grey md:border-r absolute max-md:top-[64px] bg-white max-md:w-[calc(100%+80px)] max-md:px-16 max-md:-ml-7 duration-500 "+(!showSidebnav ? "max-md:opacity-0 max-md:pointer-events-none":"opacity-100 pointer-events-auto")}>
                ...
                <div className="mx-md:-mt-8 mt-5 w-full">
                   <Outlet/>  {/*child route navigate from this */}
                </div>
