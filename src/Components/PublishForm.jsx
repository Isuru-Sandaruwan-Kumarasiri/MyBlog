...
function PublishForm() {
 ...
 const handleKeyDown=(e)=>{
  ...
  if(e.keycode==13 || e.keyCode==188){
    ...
    //console.log(tag)// by the using ','
    if(tags.length<tagLimit){  //tags ====>tags is array in destructring variable 
    ...
    <Page_Animation>
      <section  className='w-screen min-h-screen grid items-center lg:grid-cols-2 py-16 lg:gap-4'>
        ...
        <div className='border-grey lg:border-1 lg:pl-8'>
           ...
           <p className='mt-1 text-dark-grey text-sm text-right'>{CharactorLimit-des.length} characters left</p>

           <p className='text-dark-grey mb-2 mt-9'>Topics-(Helps is searching and ranking your blog)</p>
